...
public class Helpers {
  ...
  /**
   * Converts a camel case string into an enum-style string, ie myEnumValue ->
   * MY_ENUM_VALUE. Inverse of enumToCamelCase
   * 
   * @param str
   * @return
   */
  public static String deserialiseEnum(String str) {
    if (str == null)
      return null;
