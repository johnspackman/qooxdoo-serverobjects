...
public class BasicObjectMapper extends ObjectMapper {
  ...
  /*
   * Serialises a file, but only showing the part of the path relative to the
  ...
  protected void createEnumModule() {
    ...
    // This DeSerializer is beta because of difficulties finding out what enum to
    // deserialise
    // as; that problem may have been solved, but RequestHandler still has the code
    // that
