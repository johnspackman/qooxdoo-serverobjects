...
public class ArrayUtils {
  ...
  /**
   * Adds every item in an array into a collection; uses reflection so that arrays
   * of primitives are supported
   * 
   * @param col
   * @param items
   */
  ...
  /**
   * Removes every item in an array from a collection; uses reflection so that
  ...
  /**
   * Tests to see if the collection and the array have the same (or equivalent)
   * cotents)
   * 
   * @param col
   * @param array
  ...
  /**
   * Forces collection to match the order of the array, ignoring missing elements
   * on either side. Elements in col which are not present in array have their
   * ordering preserved but are placed at the end of col; elements in array which
  ...
  /**
   * Removes every item in an array from a map; uses reflection so that arrays of
