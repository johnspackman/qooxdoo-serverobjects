 ...
 *
 */
public class SerialisationTests7 extends AbstractRemoteTestCase {

	public void test1() throws Exception {
		StringWriter sw = new StringWriter();
		PrintWriter pw = new PrintWriter(sw);

		pw.println(tracker.toJSON(new TestProperties()));
		assertFromFile(sw.toString(), "SerialisationTests7.test1");
	}
