...
qx.Class.define("com.zenesis.qx.remote.ProxyManager", {
	...
	/**
	 * Constructor
	 * @param proxyUrl {String} the URL for communicating with the server
...
//								debugger;
		...
		/**
		 * Mark an object as disposed on the client and needing to have the corresponding server 
		 * object remove from the session tracker 
		 * @param obj
		 */
